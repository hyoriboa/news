            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading" style="background-color:#337AB7; color:white;">
                        <h2 style="margin-top:0px; margin-bottom:0px;">Tin tức công nghệ </h2>
                    </div>
                        ...
                        @if(count($tl->loaitin) > 0)
                            <!-- item -->
                                <div class="row-item row">
                                    ...
                                    $tin1 = $data->shift();//shift tra du lieu ra mang->tin1 la mang
                                    ?>
                                    ...
                                    <div class="col-md-8 border-right">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <a class="btn btn-primary"
                                               href="tintuc/{{$tin1['id']}}/{{$tin1['TieuDeKhongDau']}}.html">Xem thêm
